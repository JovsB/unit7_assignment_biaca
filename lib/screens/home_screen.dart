                  ...
                  return Padding(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        //  alternative details, if no available description
                        ...
                        return ExpandedTile(
                          ...
                          leading: character['imageUrl'] != null && character['imageUrl'].isNotEmpty
                              ? GestureDetector(
                                  onTap: () {
                                    //  full screen dialog image when clicked
                                    showDialog(
                                      context: context,
                                      barrierDismissible: true, // tap outside closes the dialog
                                      builder: (context) {
                                        return Dialog(
                                  ...
                                  child: Image.network(
                                    ...
                                    errorBuilder: (context, error, stackTrace) {
                                      // show gray box if image fails to load
                                      return Container(
